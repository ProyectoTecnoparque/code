    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('/Index/cargarVistaInicio'); ?>">
                ...
                <div class="sidebar-brand-text mx-3">Hawah</div>
            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo base_url('/img/avatar.png'); ?>">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                              
                                <a href="<?php echo base_url('Home/cerrarSession') ?>" class="dropdown-item">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Perfil
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php base_url('/Inicio/cerrarsession');?>" data-toggle="modal" data-target="#logoutModal">
